...
public class SublimationLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "WS", "KG", "ID", "STRING", "NUMBER", "ARROW", 
			"SIGN", "ESC", "UNICODE", "HEX"
		};
	}
	...
	public SublimationLexer(CharStream input) {
		super(input);
